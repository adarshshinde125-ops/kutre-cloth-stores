...
export const translations = {
  en: {
    ...
    faqThreeQuestion: "How is the order confirmed?",
    faqThreeAnswer: "Orders are confirmed on WhatsApp after the customer sends product details and contact information.",
  ...
  mr: {
    ...
    faqThreeQuestion: "ऑर्डर कशी कन्फर्म होते?",
    faqThreeAnswer: "ग्राहकाने प्रॉडक्ट आणि संपर्क माहिती पाठवल्यानंतर ऑर्डर WhatsApp वर कन्फर्म केली जाते.",
